# StreamCap Fork - 详细功能文档

> 这是 [README.md](README.md) 的详细补充文档，包含完整的技术细节和使用说明。

本文档详细介绍了基于 [ihmily/StreamCap](https://github.com/ihmily/StreamCap) 开发的定制版本的所有功能扩展。
